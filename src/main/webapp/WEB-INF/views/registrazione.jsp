            ...
            <form role="form" action="Register" method=post>
                ...
                <div class="row">
                    <div class="col-xs-8 col-sm-9 col-md-9">
                        Cliccando <strong class="label label-primary">Registrati</strong>, accetti le <a href="#" data-toggle="modal" data-target="#t_and_c_m">Condizioni contrattuali</a> di questo sito ed il nostro utilizzo di Cookie.
                    </div>
                </div>

                <hr class="colorgraph">
                <div class="row">
                    <div class="col-xs-12 col-md-6"><input type="submit" value="Registrati" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Condizioni contrattuali</h4>
                </div>
